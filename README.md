...
This repo is set up like I had the project set up. If you wish to copy it, you may have to fiddle around with the setup.
You will also need to download the data and place it in the data directory.
